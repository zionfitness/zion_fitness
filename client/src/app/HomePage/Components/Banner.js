...
// import Img from "../../../assets/HomeImages/Banner.webp";
import Img from "@/assets/HomeImages/Banner.webp"
        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <span className="text-[11px]  font-regular tracking-[0.15em] uppercase text-[#F28C28]">
              North Chennai&rsquo;s Exclusive Showroom
            </span>
          </motion.div>
          ...
          >
            Power Every Workout with{" "}
            <span className="text-[#F28C28]">Right</span>
            <br /> Equipment
          </motion.h1>
          ...
          >
            Explore a wide range of premium cardio and home-gym equipment for
            home workouts, professional training spaces and commercial gyms.
            From treadmills and spin bikes to ellipticals and multi-functional
            trainers, find equipment designed for performance, durability and
            consistent workouts.
          </motion.p>
