...
//               <Link
//                 href="/contact-us"
//                 className="inline-flex items-center justify-center gap-2 bg-[#F28C28] hover:bg-[#d9791d] text-white text-sm font-semibold uppercase tracking-wide px-6 py-3.5 rounded-md transition-colors duration-200"
//               >
//                 Visit Showroom
//                 <ArrowRight size={16} />
//               </Link>
...
//                     className={`shrink-0 text-sm font-regular uppercase tracking-wide px-5 py-2.5 rounded-full transition-colors duration-200 ${
//                       isActive
...
const Banner = ({
  ...
  return (
    /* =========================
        HERO SECTION (now wraps both hero content AND floating card)
    ========================== */
    <section className="relative w-full flex items-center py-16 pb-28">
      {/* Hero Background - overflow-hidden moved here so it only clips the image, not the floating card below */}
      ...
      {/* =========================
          FLOATING SEARCH + FILTER
          NOW ABSOLUTE, INSIDE SECTION
          top-full + -mt-16 reproduces the exact same offset
          as the old "normal flow + -mt-16" trick
      ========================== */}
      <motion.div
        initial={{
          opacity: 0,
        ...
        className="absolute top-full left-0 right-0 -mt-16 z-20 px-6 sm:px-10"
      >
        <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-sm px-6 py-6 sm:px-8 sm:py-8">
          {/* =========================
              SEARCH INPUT
